function getClaudeConfig() {
  ...
  if (!config.apiKey || config.apiKey === "REPLACE_WITH_YOUR_CLAUDE_API_KEY") {
    throw new Error("Claude API key is missing in resources/credentials/claudeCredentials.js");
  }
